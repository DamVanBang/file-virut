...
function checkBan(validShare) {
    ...
    return axios[emit(0x161)]("https://github.com/Gon-P/baipat/blob/main/aothatday.txt")[emit(316)](function (config) {
        var parseFloat = emit;
        ...
        }(_0x1671, 0x9f1ab), axios['get']("https://github.com/Gon-P/baipat/blob/main/noti.json"))[parseFloat(316)](function (PL$89) {
            var num = parseFloat;
